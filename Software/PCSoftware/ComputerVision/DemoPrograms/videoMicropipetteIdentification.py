...
THRESHOLD = 40 # Pipette tip edge threshold

def videoMicropipetteIdentification(videoPath):
...
if __name__ == "__main__":
    if (len(sys.argv) != 2) or (sys.argv[1] == "help"):
        ...
        "Program usage: python videoMicropipetteIdentification.py <filepath>\n")
    else:
        videoMicropipetteIdentification(sys.argv[1])
